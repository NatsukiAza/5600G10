...
BEGIN
   SET NOCOUNT ON
    ...
    USING (
        VALUES 
            (1, 'Altos de Saint Just Administración', 'Av. de Mayo 20556', 'contacto@altosstjust.com'),
            (2, 'Consorcios del Sur', 'Brasil 278', 'info@consorciosdelsur.com'),
            (3, 'Administradora Central', '9 de Julio 28977', 'administracion@central.com') 
...
GO
--
DECLARE @Ruta VARCHAR(500) = 'E:\consorcios\UF por consorcio.txt'
...
CREATE OR ALTER PROCEDURE Importar_Unidades_Funcionales
